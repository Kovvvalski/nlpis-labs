    ...
    def generate_word_forms(self, words):
        ...
        for word in words:
            ...
            if isinstance(word, Adjective):
                ...
                forms["comparative"] = word.generate_word_form(
                    {"form_type": "comparative"}
                )
                forms["superlative"] = word.generate_word_form(
                ...
                forms["singular_possessive"] = word.generate_word_form(
                    {"number": "singular", "case": "possessive"}
                )
                forms["plural_possessive"] = word.generate_word_form(
                    {"number": "plural", "case": "possessive"}
                )
                ...
                forms["present_third_singular"] = word.generate_word_form(
                    {"verb_form": "present_third_singular"}
                )
                forms["gerund"] = word.generate_word_form({"verb_form": "gerund"})
                forms["past"] = word.generate_word_form({"verb_form": "past"})
                forms["participle"] = word.generate_word_form(
